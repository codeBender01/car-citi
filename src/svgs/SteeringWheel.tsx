export default function SteeringWheel() {
  return (
    ...
    >
      <g clipPath="url(#clip0_7237_4860)">
        <mask
          id="mask0_7237_4860"
        ...
        <g mask="url(#mask0_7237_4860)">
          ...
          />
          <path
            d="M7.40845 16.5234C7.40845 12.2875 5.64516 11.2628 4.00709 11.25C2.58632 11.239 1.25977 11.9959 1.25977 11.9959"
            stroke="#0C1002"
            strokeWidth="1.5"
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          />
          <path
            d="M10.5898 16.5234C10.5898 12.2266 12.4042 11.2347 14.0617 11.25C15.4556 11.2629 16.7385 11.9959 16.7385 11.9959"
            stroke="#0C1002"
            strokeWidth="1.5"
            strokeMiterlimit="10"
            strokeLinecap="round"
