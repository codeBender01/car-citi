...
export default function FullList({ width = 51, height = 60, className }: FullListProps) {
  return (
    <svg
      width={width}
      height={height}
      ...
      className={className}
    >
      <g clipPath="url(#clip0_7208_85138)">
        <path
        ...
        />
        <path
          d="M23.3711 41.317L36.6295 28.0586"
          stroke="black"
          strokeWidth="3"
          strokeMiterlimit="10"
          strokeLinecap="round"
