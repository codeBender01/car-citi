...
interface AddCharacteristicModalProps {
  ...
  setFormData: Dispatch<SetStateAction<NewCharacteristic>>;
  onSubmit: (e: React.FormEvent) => void;
}

export const AddCharacteristicModal = ({
  open,
  onOpenChange,
  formData,
  setFormData,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {formData.id ? "Редактировать характеристику" : "Добавить характеристику"}
          </DialogTitle>
          <DialogDescription>
            {formData.id
              ? "Обновите характеристику"
              : "Создайте новую характеристику для автомобилей"}
          </DialogDescription>
        </DialogHeader>
