...
interface AddFuelTypeModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  formData: NewFuelType;
  setFormData: Dispatch<SetStateAction<NewFuelType>>;
  onSubmit: (e: React.FormEvent) => void;
}

export const AddFuelTypeModal = ({
  open,
  onOpenChange,
  formData,
  setFormData,
  onSubmit,
}: AddFuelTypeModalProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[500px]">
        <DialogHeader>
          <DialogTitle>Добавить тип топлива</DialogTitle>
          <DialogDescription>
            Создайте новый тип топлива для автомобилей
          </DialogDescription>
        </DialogHeader>
