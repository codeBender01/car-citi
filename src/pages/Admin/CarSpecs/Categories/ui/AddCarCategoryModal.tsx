...
interface AddCarCategoryModalProps {
  ...
  formData: NewCarCategory;
  setFormData: Dispatch<SetStateAction<NewCarCategory>>;
  onSubmit: (e: React.FormEvent) => void;
}

export const AddCarCategoryModal = ({
  open,
  onOpenChange,
  formData,
  setFormData,
  onSubmit,
}: AddCarCategoryModalProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[500px]">
        <DialogHeader>
          <DialogTitle>Добавить категорию автомобиля</DialogTitle>
          <DialogDescription>
            Создайте новую категорию для автомобилей
          </DialogDescription>
        </DialogHeader>
