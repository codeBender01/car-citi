...
interface AddDriveTypeModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  formData: NewDriveType;
  setFormData: Dispatch<SetStateAction<NewDriveType>>;
  onSubmit: (e: React.FormEvent) => void;
}

export const AddDriveTypeModal = ({
  open,
  onOpenChange,
  formData,
  setFormData,
  onSubmit,
}: AddDriveTypeModalProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[500px]">
        <DialogHeader>
          <DialogTitle>Добавить тип привода</DialogTitle>
          <DialogDescription>
            Создайте новый тип привода для автомобилей
          </DialogDescription>
        </DialogHeader>
